...
const Add = ({ token }) => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      ...
      <div className="w-full flex flex-col sm:flex-row gap-2 sm:gap-8 mt-3">
        <div>
          ...
          >
            ...
            <option value="wear">Sports Wear</option>
          </select>
        </div>
      ...
      <button
        type="submit"
        className="w-28 py-3 mt-4 bg-yellow-800 text-white rounded"
      >
        ADD
      </button>
    </form>
